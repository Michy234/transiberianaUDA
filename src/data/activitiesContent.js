...
export const DEFAULT_ACTIVITY_SEASON_COPY = {
  ...
  summer: 'Ore centrali piu intense, ma aria di montagna e ombra rendono le soste piacevoli.',
  autumn: 'Foliage, prodotti tipici e luce morbida: il viaggio diventa piu narrativo e gastronomico.',
...
export const DEFAULT_ACTIVITY_STOPS = [
  {
    ...
    desc: "La citta dei confetti e di Ovidio: prima porta del viaggio e ritorno naturale per chiudere la giornata tra piazze, musei e botteghe.",
    ...
    seasonContext: {
      ...
      summer: "Le visite rendono di piu tra tardo pomeriggio e sera, cercando ombra tra Corso Ovidio, Porta Napoli e Piazza XX Settembre.",
      autumn: "Musei, botteghe e prodotti simbolo come confetti e aglio rosso raccontano la citta con un ritmo piu lento.",
      winter: "Quando il treno rientra e gia buio, i portici di Corso Ovidio, l'Annunziata e le vetrine illuminate diventano la scelta migliore.",
    },
    highlights: [
    ...
    practicalNote:
      "Sulmona e la fermata piu flessibile del viaggio: resta nel centro storico se hai poco margine, mentre Badia Morronese ed Eremo di Sant'Onofrio hanno senso solo con molto anticipo o con un pernottamento in citta.",
    howItWorks: [
      ...
      'Confetti e botteghe artigiane sono il souvenir piu semplice da gestire senza allontanarti.',
    ],
    plans: [
      {
        id: 'sulmona-breve',
        ...
        summary: 'Un percorso compatto tra i simboli della citta, con una pausa dolce facile da incastrare.',
        logistics: 'Restando tra Piazza Garibaldi, Corso Ovidio e Annunziata mantieni tutto raggiungibile a piedi.',
        mealTip: 'Confetti artigianali, aperitivo leggero o gelato in centro sono le pause piu facili da gestire.',
        activities: {
          spring: [
          ...
          autumn: [
            "Visita al Museo dell'Arte Confettiera Pelino, cuore della memoria dolce della citta.",
      ...
      },
      {
        ...
        summary: 'Piu tempo per unire visita culturale, passeggiata distesa e pausa seduta.',
        logistics: 'Puoi aggiungere un museo o una chiesa monumentale senza uscire dal perimetro del centro storico.',
        mealTip: 'Con piu tempo funziona bene una trattoria del centro o una cena calda al rientro.',
        activities: {
          spring: [
            "Annunziata, acquedotto e centro storico con passo lento, lasciando spazio a foto e dettagli architettonici.",
            "Se sei in citta da prima, Badia Morronese ed Eremo di Sant'Onofrio sono la deviazione culturale extra.",
          ],
          summer: [
            'Domus Romana e passeggiata serale lungo Corso Ovidio quando il sole cala.',
            "Sosta lunga tra piazze, botteghe e tavolini all'aperto nel cuore della citta.",
          ],
          autumn: [
          ...
          winter: [
            ...
            "Cena in osteria con piatti caldi come chitarra al ragu d'agnello o zuppa di legumi.",
          ],
        },
      },
    ],
  },
  {
    ...
    timeHint: 'Il borgo e raccolto: una visita a piedi semplice e mirata basta per viverlo bene.',
    ...
    schedule: {
      ...
      duration: '1 h 30 - 2 h',
      note: 'Il tempo e limitato ma sufficiente per un anello nel centro storico, una visita culturale e una sosta gastronomica veloce.',
    },
    seasonContext: {
      spring: 'Il clima resta fresco e piacevole: e la stagione migliore per leggere dettagli architettonici e portali scolpiti.',
      summer: "L'altitudine mantiene l'aria leggera: le rue in ombra e i balconi fioriti sono il set naturale della visita.",
      autumn: 'Il borgo fortificato dialoga con il foliage della Majella e con sapori di stagione piu decisi.',
    ...
    highlights: [
      ...
      'Casa Quaranta, tra le abitazioni piu antiche del paese.',
      'Palazzo Nanni e memoria della transumanza.',
      'Piazza Duval e il perimetro del borgo fortificato.',
    ],
    practicalNote:
      'Campo di Giove si visita bene a piedi: il centro e raccolto e conviene non allungarsi troppo oltre il borgo se vuoi tenere margine per pranzo, acquisti o rientro al treno.',
    howItWorks: [
      'Dalla stazione punta subito al centro storico senza disperdere il tempo in deviazioni lunghe.',
      'Il percorso piu equilibrato unisce chiesa madre, rue e piazza principale.',
    ...
    plans: [
      {
        ...
        mealTip: 'Pane caldo, prodotti da forno e una bevanda in centro sono la scelta piu agile.',
        activities: {
          spring: [
          ...
          winter: [
            "Chiesa di Sant'Eustachio e portali in pietra resi ancora piu suggestivi dalla neve.",
      ...
      },
      {
        ...
        summary: 'Un percorso piu disteso che aggiunge luoghi identitari e qualche acquisto mirato.',
        ...
        activities: {
          ...
          winter: [
            'Giro nel centro innevato cercando i portali piu belli e i passaggi piu raccolti delle rue.',
  ...
  },
  {
    ...
    timeHint: 'La stazione non e in paese: la sosta cambia molto se c e o no la navetta.',
    desc: 'Nel Quarto Santa Chiara la ferrovia tocca uno dei suoi punti piu scenografici: alta quota, silenzio e un borgo raggiungibile solo in alcuni itinerari.',
    ...
    schedule: {
      ...
      note: 'La stazione e al Valico della Forchetta, circa 8-9 km sopra il centro abitato. In inverno la sosta resta di solito in quota.',
    },
    seasonContext: {
      spring: 'Quando la corsa prevede la navetta, e il momento migliore per unire natura, area faunistica ed eremi.',
      summer: 'L alta quota tiene la temperatura bassa e rende possibile una visita breve ma molto scenografica.',
      autumn: 'Il foliage del Quarto Santa Chiara e uno dei motivi piu forti per scendere dal treno anche per poco.',
      winter: 'Palena in inverno e soprattutto una fermata fotografica: neve, vento e treno storico creano il momento piu iconico del viaggio.',
    },
    highlights: [
    ...
    practicalNote:
      'Qui la logistica conta piu che altrove: se resti in stazione punta su panorama, foto e pausa breve; se c e navetta scegli in anticipo due tappe, perche il tempo reale nel borgo e inferiore al totale.',
    howItWorks: [
    ...
    plans: [
      {
        ...
        summary: 'La versione piu essenziale ma anche piu cinematografica di Palena, attorno alla stazione.',
        logistics: 'Restando nei dintorni della stazione sfrutti al massimo il tempo e non dipendi da trasferimenti.',
        mealTip: 'Quando presenti, i piccoli ristori temporanei con bevande calde e dolci sono la pausa piu pratica.',
        activities: {
          spring: [
          ...
          summer: [
            ...
            'Sessione fotografica con il treno e il paesaggio aperto di una delle fermate piu scenografiche.',
          ],
          autumn: [
          ...
          winter: [
            'Panorama innevato e scatti al treno nella neve, forse il momento piu iconico di tutta la giornata.',
            'Te caldo o vin brule nei ristori temporanei, quando presenti.',
          ],
        },
      },
      {
        ...
        summary: 'Quando il trasferimento e previsto, Palena aggiunge castello, museo e luoghi spirituali della Majella.',
        ...
        activities: {
          ...
          winter: [
            'Se la navetta e prevista anche con freddo intenso, limita la visita a un asse centrale del borgo.',
  ...
  },
  {
    ...
    timeHint: 'Qui c e margine per pranzo e passeggiata: la fermata regge un ritmo piu disteso.',
    desc: 'Ricostruita dopo la guerra e oggi elegante localita montana, Roccaraso alterna memoria storica, shopping, pineta e turismo stagionale.',
    ...
    schedule: {
      ...
      note: 'Di solito c e tempo sufficiente per pranzare con calma e fare una passeggiata completa tra centro, pratone o pineta.',
    },
    seasonContext: {
      spring: 'La fine della neve restituisce prati e sentieri facili: e il momento migliore per camminare senza fretta.',
      summer: "L'aria fresca rispetto alla pianura rende piacevoli pineta, centro e pranzo all'aperto.",
      autumn: 'Roccaraso cambia registro: sapori di bosco, luce limpida e memoria della ricostruzione emergono di piu.',
      winter: 'Qui il viaggio incontra la localita sciistica: neve, mercatini, dolci caldi e un centro molto piu animato.',
    },
    highlights: [
    ...
    practicalNote:
      'Roccaraso permette di allargare il raggio piu delle altre fermate: puoi pranzare con calma e poi scegliere se restare tra centro e shopping o spostarti verso pratone e pineta, senza forzare una camminata lunga.',
    howItWorks: [
      'Considera il pranzo come parte della visita, non come interruzione.',
      'Il centro e lineare: Via Roma, piazza, chiesa e monumenti si leggono bene in sequenza.',
    ...
    plans: [
      {
        ...
        summary: 'Un percorso essenziale per cogliere il carattere elegante e stagionale della localita.',
        logistics: 'Concentrati su centro e piazze, lasciando sentieri e pineta a una sosta piu lunga.',
        ...
        activities: {
          ...
          autumn: [
            'Via Roma fino a Santa Maria Assunta, con luce limpida e temperature piu fresche.',
      ...
      },
      {
        ...
        logistics: 'Dopo pranzo scegli un solo asse esteso: centro con memoria storica oppure pineta con attivita outdoor.',
  ...
  },
  {
    ...
    timeHint: 'Una delle soste piu comode: puoi pranzare senza fretta e aggiungere una vera visita culturale.',
    desc: "L'antica Aufidena unisce fiume, musei, palazzi storici e quartieri alti: e la fermata che regge meglio un itinerario completo.",
    ...
    schedule: {
      ...
      duration: '3-4 ore',
      note: 'La sosta e abbastanza lunga da permettere pranzo, centro storico e almeno una visita museale o panoramica.',
    },
    seasonContext: {
      spring: 'Le giornate piu lunghe rendono naturale un percorso tra fiume, convento e quartiere alto della Civita.',
      summer: 'Nelle ore centrali conviene alternare chiostri, musei e vicoli ombreggiati come Terravecchia.',
      autumn: 'Il Sangro, i ponti e i colori del foliage danno un tono piu lento e fotografico alla visita.',
    ...
    practicalNote:
      'Castel di Sangro consente davvero di combinare pranzo e cultura: scegli prima se vuoi privilegiare il fiume e il complesso della Maddalena oppure i quartieri alti, cosi eviti di frammentare troppo il pomeriggio.',
    howItWorks: [
      ...
      'Prima del rientro resta nel centro per acquisti facili come miele, formaggi o specialita al tartufo.',
    ],
    plans: [
      {
        id: 'castel-breve',
        ...
        mealTip: 'Trattoria del centro o pausa veloce in piazza sono le opzioni piu efficienti.',
        activities: {
          spring: [
          ...
          summer: [
            'Convento della Maddalena, piu fresco e ombreggiato nelle ore centrali.',
          ...
          autumn: [
            ...
            'Acquisti di miele, formaggi stagionati o specialita al tartufo prima della ripartenza.',
          ],
          winter: [
            'Piazza Plebiscito e pranzo caldo nel cuore della citta.',
      ...
      },
      {
        ...
        logistics: 'Con piu tempo puoi visitare un museo e chiudere il percorso con Civita o ciclopedonale.',
