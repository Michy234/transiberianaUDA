  ...
  return (
    <div className="w-full relative overflow-hidden bg-background">
      ...
      <section className="min-h-[100dvh] w-full flex flex-col lg:flex-row relative">
        {/* Left Content (55%) */}
        <div className="w-full lg:w-[55%] flex flex-col justify-center px-6 md:px-12 lg:px-20 pt-4 lg:pt-32 pb-16 z-10 relative order-2 lg:order-1 -mt-2 lg:mt-0">
          <motion.div
        ...
        <div className="w-full lg:w-[45%] min-h-[58vh] sm:min-h-[50vh] lg:min-h-0 relative px-4 sm:px-6 lg:px-8 py-2 sm:py-4 md:py-6 lg:py-8 flex items-center justify-center order-1 lg:order-2">
          <motion.div 
